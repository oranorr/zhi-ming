...
abstract interface class AdaptyRepository {
  ...
  /// Устанавливает флаг hasUsedFreeReading в false
  Future<void> resetFreeReadingFlag();

  /// Сброс счетчика фоллоу-ап вопросов (для тестирования)
  /// Восстанавливает максимальное количество фоллоу-ап вопросов
  Future<void> resetFollowUpQuestionsCount();

  /// Полный сброс всех данных пользователя (для тестирования)
  /// Сбрасывает флаг бесплатного гадания, счетчики и подписку на эмуляторе
  Future<void> resetUserData();

  /// Детальное логирование состояния пользователя для отладки
  /// Выводит все данные о состоянии пользователя в лог
  Future<void> logUserState();
}
