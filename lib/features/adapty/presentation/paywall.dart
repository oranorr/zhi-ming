  ...
  Future<void> _openTermsAndConditions() async {
    try {
      ...
      if (await canLaunchUrl(url)) {
        ...
        debugPrint('[PaywallBody] Открыт Terms & Conditions: $url');
      } else {
        debugPrint('[PaywallBody] Не удается открыть URL: $url');
      ...
      debugPrint('[PaywallBody] Ошибка открытия Terms & Conditions: $e');
  ...
  Future<void> _openPrivacyPolicy() async {
    try {
      ...
      if (await canLaunchUrl(url)) {
        ...
        debugPrint('[PaywallBody] Открыт Privacy Policy: $url');
      } else {
        debugPrint('[PaywallBody] Не удается открыть URL: $url');
      ...
      debugPrint('[PaywallBody] Ошибка открытия Privacy Policy: $e');
